        ...
        function montaTabela(dados){
            ...
            for(aluno of dados){
                ...
                str += "<tr><td>"+aluno.id+"</td><td>"+aluno.nome+'</td><td>'+aluno.dtnasc+'</td><td>'+aluno.email+'</td><td>'+aluno.senha+'</td><td>'+aluno.telefone+'</td><td>'+aluno.sexo+'</td><td>'+aluno.turma+'</td><td>'+editar+'</td><td>'+excluir+'</td></tr>';
            }
        ...
        $('#form-contato').submit(function(){
            ...
            if (turma.val() == '' || turma.val() <= 0) {
                erro.removeClass('d-none');
                campo.html('turma'); // nome do campo que não foi preenchido!
                turma.focus();
